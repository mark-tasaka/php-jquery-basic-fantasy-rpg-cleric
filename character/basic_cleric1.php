...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<meta charset="UTF-8">
	<meta name="description" content="Basic Fantasy RPG Cleric Character Generator. Goblinoid Games.">
...
<body>
    ...
    $undead1Hd = turnHd1 ($level);
    $undead2Hd = turnHd2 ($level);
    $undead3Hd = turnHd3 ($level);
    $undead4Hd = turnHd4 ($level);
    $undead5Hd = turnHd5 ($level);
    $undead6Hd = turnHd6 ($level);
    $undead7Hd = turnHd7 ($level);
    $undead8Hd = turnHd8 ($level);
    $undead9Hd = turnHd9 ($level);
  ...
  <img id="character_sheet"/>
   <section>
       ...
       <span id="totalArmourWeight">
            <?php
                echo "Armour/shield weight: " . $totalArmourWeight . " lbs";
            ?>
       </span>
  ...
  <script>
	...
	*/
	function Character() {
        ...
        let	wisdom = <?php echo rand(9, 18) ?>;
        let dexterityBase = rollDice(6, 3, 0, 0);
