...
<html>
<head>
<title>Launch Page: Basic Fantasy RPG Cleric Generator</title>
	...
	<section>
		...
		<form action="" id ="clericForm"  target="_blank" method="post">
            ...
            <div id="gearGroupings">
                ...
                <input type="checkbox" name="theGear[]" value="37"> Thieves' Tools<br/>   
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#clericForm").attr('action', "character/basic_cleric" + $("#abilityScores").val() +  ".php");
